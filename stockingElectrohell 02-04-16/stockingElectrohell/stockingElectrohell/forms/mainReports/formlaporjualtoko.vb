...
Public Class formlaporjualtoko
    ...
    Private Sub loadGrid()
        ...
        tempdt2 = clasg.loadFilteredDataTable("SELECT kodeitem,value,sum(qty) as qty from tb_penjualandetail inner join tb_penjualan" & _
                                              " on tb_penjualandetail.kode = tb_penjualan.kode where tb_penjualan.statjual ='Toko'" & param & _
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf cbtoko.Checked = True Then
            ...
            Else
                ...
                param = "and nama = '" & txnama.Text & "' and tgl between '" & tanggal.ToMySql & "' and '" & tanggal1.Year & "-" & _
                    tanggal1.Month & "-" & tanggal1.Day & " 23:59:59' "
                dGridAll.Rows.Clear()
                loadGrid()
            End If
